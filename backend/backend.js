...
const app = http.createServer(async (req, res) => {
  ...
  //accessToken: guardarlo en local storage o http only
  if (req.method === 'POST' && parsedUrl.pathname === `/api/animals`) { //aca seria para poder agregar un animal

  }
  if (req.method === 'GET' && parsedUrl.pathname === `/api/animals`) { 

  }
  if (req.method === 'GET' && parsedUrl.pathname === `/api/animals/position`) { 
  /*
    id
    lat
    long
  ...
  */
  ...
  if (req.method === 'DELETE' && parsedUrl.pathname === `/api/animals/id`) { 

  }
  if (req.method === 'PATCH' && parsedUrl.pathname === `/api/animals/id`) { 

  }

  if (req.method === 'POST' && parsedUrl.pathname === `/api/checkpoints`) { 

  }
  if (req.method === 'GET' && parsedUrl.pathname === `/api/checkpoints`) { 

  }
  if (req.method === 'DELETE' && parsedUrl.pathname === `/api/checkpoints/id`) { 

  }
  if (req.method === 'PATCH' && parsedUrl.pathname === `/api/checkpoints/id`) { 

  }

  if (req.method === 'POST' && parsedUrl.pathname === `/api/refresh`) {
    /*
    mandas:
      header.auth.bearer
      refreshToken
